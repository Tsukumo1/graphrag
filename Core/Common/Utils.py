...
def clean_str(input: Any) -> str:
    ...
    # Remove non-alphanumeric characters but keep Greek letters and convert to lowercase
    # Greek letters Unicode ranges: U+0370-U+03FF (Greek and Coptic), U+1F00-U+1FFF (Greek Extended)
    return re.sub(r'[^A-Za-z0-9\u0370-\u03FF\u1F00-\u1FFF ]', ' ', result.lower()).strip()
