...
Rules:
- Extract all proper nouns, organizations, countries, people, places, and important concepts.
- Include both English and non-English names (like al-Shabaab).
- Be comprehensive but accurate.
- VERY IMPORTANT: 
  When a country name and another entity (organization, institution, title, people, group, place) have an affiliation/association relationship 
  (such as "of", "in", "from", "by", "for", "with", "among", "inside", "outside"), 
  (not "before", "after", "next to", "beside", "on"),
  ALWAYS merge them into ONE single entity. NEVER return them separately.
  Example: 
    Paragraph: Muslims in the United Kingdom
    Wrong: ["Muslims", "United Kingdom"] 
    Correct: ["Muslims United Kingdom"]

Examples:
[1] Paragraph: When did the al-Shabaab insurgency use unconventional violence against Muslims in the United Kingdom?
{{"named_entities": ["al-Shabaab", "Muslims United Kingdom"]}}

[2] Paragraph: Who praised the royal administration of Saudi Arabia before October 2006?
{{"named_entities": ["royal administration Saudi Arabia"]}}

[3] Paragraph: In which year did the Foreign Affairs of India make an appeal to the Prime Minister of India?
{{"named_entities": ["Foreign Affairs India", "Prime Minister India"]}}

[4] Paragraph: Which country was the last to accuse the UN security council before the Military Personnel of Canada did?
{{"named_entities": ["UN security council", "Military Personnel Canada"]}}
